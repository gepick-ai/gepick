...
export class MessagingService extends InjectableService implements IApplicationContribution {
  constructor(
    // @IConnectionHandlerContributions private contributions: IConnectionHandlerContribution[],
    @IConnectionHandlerContributionProvider private readonly provider: IContributionProvider<ConnectionHandler>
  ) {
    super();
