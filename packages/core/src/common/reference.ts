...
import {  DisposableCollection, IDisposable, toDisposable } from './lifecycle';
import { MaybePromise } from './types';

export interface Reference<T> extends IDisposable {
    readonly object: T
}
 ...
 */
export abstract class AbstractReferenceCollection<K, V extends IDisposable> implements IDisposable {
    ...
    constructor() {
        ...
        this.toDispose.push(toDisposable(() => this.clear()));
    }
 ...
 * created immediately.
 */
export class ReferenceCollection<K, V extends IDisposable> extends AbstractReferenceCollection<K, V> {
 ...
 * function.
 */
export class SyncReferenceCollection<K, V extends IDisposable> extends AbstractReferenceCollection<K, V> {
