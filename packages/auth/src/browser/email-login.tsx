...
import "@gepick/auth/browser/style/email-login.scss"
...
export const EmailLoginButton = defineComponent({
  name: "EmailLogin",
  props: EmailProps(),
  setup(props) {
    return () => (
      <div class="email-login-btn" onClick={props.onClick}>
        <div class="email-icon">
          <svg viewBox="0 -31.5 256 256" width="100%" height="100%" fill="none" style="user-select: none; flex-shrink: 0;">
            <g>
        ...
        <div class="email-title">邮箱登录</div>
      </div>
    )
  },
})
