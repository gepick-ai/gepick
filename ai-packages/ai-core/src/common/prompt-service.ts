import { Event, InjectableService, Optional, URI, createServiceDecorator } from '@gepick/core/common';
import { AIVariableArg, AIVariableContext, AIVariableService, IAIVariableService, ResolvedAIVariable, createAIResolveVariableCache } from './variable-service';
import { IToolInvocationRegistry } from './tool-invocation-registry';
...
export const IPromptCustomizationService = createServiceDecorator<IPromptCustomizationService>('PromptCustomizationService');
export type IPromptCustomizationService = PromptCustomizationService;

export class PromptServiceImpl extends InjectableService implements PromptService {
  protected _prompts: PromptMap = {};

  constructor(
        @Optional() @IAISettingsService protected readonly settingsService: IAISettingsService | undefined,
        @Optional() @IPromptCustomizationService protected readonly customizationService: IPromptCustomizationService | undefined,
        @Optional() @IAIVariableService protected readonly variableService: IAIVariableService | undefined,
        @Optional() @IToolInvocationRegistry protected readonly toolInvocationRegistry: IToolInvocationRegistry | undefined,
  ) {
    super();
  }
...
export const IPromptService = createServiceDecorator<IPromptService>(PromptServiceImpl.name);
export type IPromptService = PromptServiceImpl;
