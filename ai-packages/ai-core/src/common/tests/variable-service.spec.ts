...
import {
  ...
  IAIVariableContributionProvider,
  ResolvedAIVariable,
...
describe('defaultAIVariableService', () => {
  ...
  let contributionProvider: sinon.SinonStubbedInstance<IAIVariableContributionProvider>;
  ...
  beforeEach(() => {
    ...
    } as sinon.SinonStubbedInstance<IAIVariableContributionProvider>;

    // Create the service under test
    variableService = new DefaultAIVariableService(contributionProvider);
